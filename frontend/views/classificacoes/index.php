...
/** @var frontend\models\ClassificacoesSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Classificacoes';
...
<div class="classificacoes-index">
    ...
    <?= Html::a('Criar Classificação', ['classificacoes/create'], ['class' => 'btn btn-primary modelCreateButton my-3']) ?>
    <!-- Modal -->
    <?php
        Modal::begin([
            'id' => 'modalCreate',
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            //     'urlCreator' => function ($action, classificacoes $model, $key, $index, $column) {
